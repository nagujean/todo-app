...
const defaultStoreValue = {
  ...
  sortType: "created" as "created" | "priority" | "startDate" | "endDate",
  sortOrder: "asc" as "asc" | "desc",
  setSortType: vi.fn(),
  setSortOrder: vi.fn(),
  filterMode: "all" as "all" | "incomplete" | "completed",
  setFilterMode: vi.fn(),
  toggleTodo: vi.fn(),
  deleteTodo: vi.fn(),
  updateTodo: vi.fn(),
...
describe("TodoList", () => {
  ...
  it("does not show clear completed button when no completed items", () => {
    const todos = [createMockTodo({ id: "t1", completed: false })];
    setupStore({ todos });
    render(<TodoList />);
  ...
  describe("Progress calculation", () => {
    ...
    it("shows 0 completed when none done", () => {
      const todos = [createMockTodo({ completed: false }), createMockTodo({ completed: false })];
      setupStore({ todos });
      render(<TodoList />);
