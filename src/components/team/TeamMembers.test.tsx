...
describe("TeamMembers", () => {
  ...
  it("shows role labels", () => {
    setupStores({
      members: [{ id: "u1", displayName: "Owner", email: "", role: "owner", joinedAt: "" }],
    });
    render(<TeamMembers teamId="team-1" open={true} onOpenChange={vi.fn()} />);
  ...
  it("shows (나) label for current user", () => {
    setupStores({
      currentUserId: "u1",
      members: [{ id: "u1", displayName: "Me", email: "", role: "owner", joinedAt: "" }],
    });
    render(<TeamMembers teamId="team-1" open={true} onOpenChange={vi.fn()} />);
  ...
  it("renders without dialog when open is undefined", () => {
    setupStores({
      members: [{ id: "u1", displayName: "Alice", email: "", role: "editor", joinedAt: "" }],
    });
